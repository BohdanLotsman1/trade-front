...
export const currencySelector = (state: State) =>
  state.chart.chart.currentCurrency;
export const socketCurrencySelector = (state: State) =>
  state.chart.chart.socketCurrency;
export const chartDataSelector = (state: State) => state.chart.chart.chartData;
export const currentCandleSelector = (state: State) =>
  state.chart.chart.currentCandle;
